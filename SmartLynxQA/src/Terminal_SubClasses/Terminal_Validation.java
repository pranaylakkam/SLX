...
public class Terminal_Validation {
	...
	public static MouseHandler Mouse (WebDriver driver) throws Exception{
		 ...
		 Terminal_ScreenShots.CaptureScreenshot(driver);
		 action.moveToElement(element).moveToElement(driver.findElement(By.xpath(".//*[@id='main']/div[1]/div/div[2]/div/div/ul/li[1]/ul/li[25]/a"))).click().build().perform();
...
WebElement Address = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Address']"));
 ...
 public static WebElement  State(WebDriver driver){
	 ...
	 State  = driver.findElement(By.xpath(".//*[@id='tabTerminalDetails']/div/div/fieldset[2]/div[3]/div/span[1]/span/span[2]/span"));
 ...
 public static WebElement   Latitude (WebDriver driver) throws Exception{
	  ...
	  String ExpectedLatitudeErrorMessage1 =ExcelUtils.getCellData(33, 5);
		String Latitude_ErrorMessage1 = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Latitude-error']")).getText();
	
		
		if(ExpectedLatitudeErrorMessage1.equals(Latitude_ErrorMessage1))
		{
			System.out.println(Latitude_ErrorMessage1);
			ExcelUtils.setCellData(Latitude_ErrorMessage1, 33,6);
			...
			ExcelUtils.setCellData(Latitude_ErrorMessage1, 33,6);
			ExcelUtils.setCellData("Fail", 33, 7);
		}
		
	  
	  WebElement Errorlatitide = driver.findElement(By.xpath("//*[@id='TerminalAddress_Latitude-error']"));
	  if(Errorlatitide.isDisplayed())
	  {
		  
		  
		  Latitude.clear();
		  Latitude.sendKeys(String.valueOf(ExcelUtils.getCellDataDecimals( 34, 4)));
 ...
 public static WebElement   Longitude (WebDriver driver) throws Exception{
	 ...
	 String ExpectedLongitudeErrorMessage1 = ExcelUtils.getCellData(35, 5);
		String Longitude_ErrorMessage1 = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Longitude-error']")).getText();
	
		
		if(ExpectedLongitudeErrorMessage1.equals(Longitude_ErrorMessage1))
		{
			System.out.println(Longitude_ErrorMessage1);
			ExcelUtils.setCellData(Longitude_ErrorMessage1,35, 6);
	  ...
	  WebElement ErrorLongitude = driver.findElement(By.xpath(".//*[@id='TerminalAddress_Longitude-error']"));
	  if(ErrorLongitude.isDisplayed())
	  {
		  Longitude.clear();
		  Longitude.sendKeys(String.valueOf(ExcelUtils.getCellDataDecimals(36, 4)));
...
public static WebElement   SupplierMappingSearchbox (WebDriver driver)throws Exception{
	...
	SupplierMappingSearchbox  = driver.findElement(By.xpath(".//*[@id='txtSearchSupplierMappingGrid']"));
...
public static WebElement   DriverMappingSearchbox (WebDriver driver)throws Exception{
	...
	DriverMappingSearchbox  = driver.findElement(By.xpath(".//*[@id='txtSearchDriverMappingGrid']"));
...
public static WebElement   DriverMappingCheckbox (WebDriver driver)throws Exception{
	...
	DriverMappingCheckbox  = driver.findElement(By.xpath(".//*[@id='TerminalDriversGrid']/div[2]/table/tbody/tr[1]/td[1]/input"));
...
public static WebElement  TruckMappingSerachBox (WebDriver driver)throws Exception{
	...
	TruckMappingSerachBox  = driver.findElement(By.xpath(".//*[@id='txtSearchTruckMappingGrid']"));
