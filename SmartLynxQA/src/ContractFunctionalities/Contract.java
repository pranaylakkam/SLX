...
//		Contract_FieldValidations.Number_Errorfild(driver);
		Thread.sleep(3000);
	/*--	Contract_Screenshots.CaptureScreenshot(driver);
		--Contract_FieldValidations.BeginDate(driver);
		--Thread.sleep(3000);
	--	Contract_Screenshots.CaptureScreenshot(driver);
		--ontract_FieldValidations.ExpirationDate(driver);
--		=Thread.sleep(1000);
		Contract_Screenshots.CaptureScreenshot(driver);
	*/	Contract_FieldValidations.Perpetual_Checkbox(driver).click();
	...
	Contract_FieldValidations.Terminal_Dropdown(driver).click();
		...
		Thread.sleep(6000);
	/*	Contract_Screenshots.CaptureScreenshot(driver);
		ContractEdit.BeginDate(driver);
        Thread.sleep(6000);
		Contract_Screenshots.CaptureScreenshot(driver);
		Thread.sleep(3000);
		ContractEdit.ExpirationDate(driver);
		Thread.sleep(1000);
    	*/Contract_Screenshots.CaptureScreenshot(driver);
