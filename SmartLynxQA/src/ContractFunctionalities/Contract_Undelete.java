	...
	/*	WebElement	BeginDate = driver.findElement(By.xpath(".//*[@id='tabContractDetails']/div/div/fieldset[1]/div[2]/div/span[1]/span/span/span"));
		...
		*/	
					...
					ExcelUtils.setCellData("Pass", 58, 7);
					 Thread.sleep(3000);
					 Contract_Screenshots.CaptureScreenshot(driver);
					 WebElement  Terminal_Dropdown = driver.findElement(By.xpath("//div[@id='tabContractDetails']/div/div/fieldset/fieldset[2]/div/div/span/span/span[2]/span"));
					...
					ExcelUtils.setCellData("Pass", 61, 7);
					 ...
					 Thread.sleep(7000);
					  ...
					  int ok_size1=driver.findElements(By.xpath("//*[@id='BaseContract_SupplierId_listbox']/li[2]")).size();
					     Thread.sleep(3000);
					     Contract_Screenshots.CaptureScreenshot(driver);
					    
					     driver.findElements(By.xpath("//*[@id='BaseContract_SupplierId_listbox']/li[2]")).get(ok_size1-1).click();
					     Thread.sleep(3000);
					     Contract_Screenshots.CaptureScreenshot(driver);
					    ExcelUtils.setCellData("Pass", 60, 7);
					  //   driver.findElements(By.xpath("//*[@id='BaseContract_SupplierId_listbox']/li[2]")).get(ok_size1-1).sendKeys(Keys.ENTER); 
					 
					 
					 
					 
					 
				//	 driver.findElement(By.xpath("//*[@id='BaseContract_SupplierId_listbox']/li[2]")).click();
					// Thread.sleep(5000);
				ExcelUtils.setCellData("Pass", 62, 7);
				Contract_Screenshots.CaptureScreenshot(driver);
					 Thread.sleep(3000);
					 WebElement  VendorDropdown = driver.findElement(By.xpath("//div[@id='tabContractDetails']/div/div/fieldset/fieldset[2]/div[3]/div/span/span/span[2]/span"));
					 VendorDropdown.click();
					ExcelUtils.setCellData("Pass", 63, 7);
					 Contract_Screenshots.CaptureScreenshot(driver);
					 Thread.sleep(6000);
					 int ok_size2=driver.findElements(By.xpath("//*[@id='BaseContract_VendorId_listbox']/li[2]")).size();
				     Thread.sleep(3000);
				     Contract_Screenshots.CaptureScreenshot(driver);
				    
				     driver.findElements(By.xpath("//*[@id='BaseContract_VendorId_listbox']/li[2]")).get(ok_size2-1).click();
				     Thread.sleep(3000);
				     Contract_Screenshots.CaptureScreenshot(driver);
				    ExcelUtils.setCellData("Pass", 60, 7);
				   //  driver.findElements(By.xpath("//*[@id='BaseContract_VendorId_listbox']/li[2]")).get(ok_size2-1).sendKeys(Keys.ENTER); 
				 
				 	
					// driver.findElement(By.xpath("//*[@id='BaseContract_VendorId_listbox']/li[2]")).click();
				ExcelUtils.setCellData("Pass", 64, 7);
				 Contract_Screenshots.CaptureScreenshot(driver);
					...
					ExcelUtils.setCellData("Pass", 66, 7);
					 Contract_Screenshots.CaptureScreenshot(driver);
					 Thread.sleep(3000);
					 WebElement  ProductName_Checkbox = driver.findElement(By.xpath("//*[@id='ProductTypeAhead']"));
	...
	ExcelUtils.setCellData(UpDateMessage.getText(), 94, 6);
	 ...
	 driver.findElement(By.xpath(".//*[@id='txtSearchContractGrid']")).click();
		...
		if(Verify1.getText().isEmpty()){
			...
			Thread.sleep(3000);
			Contract_Screenshots.CaptureScreenshot(driver);
	/*		WebElement	BeginDate1 = driver.findElement(By.xpath(".//*[@id='tabContractDetails']/div/div/fieldset[1]/div[2]/div/span[1]/span/span/span"));
			 BeginDate1.click();
			 Thread.sleep(3000);
			ExcelUtils.setCellData("Pass", 76, 6);
			 
				  
			  
				
				Thread.sleep(3000);
				int ok_size9=driver.findElements(By.xpath(".//a[@class='k-link'][@title ='Thursday, July 27, 2017']")).size();
				
				Thread.sleep(6000);
				driver.findElements(By.xpath(".//a[@class='k-link'][@title ='Thursday, July 27, 2017']")).get(ok_size9-1).click();
				
				Thread.sleep(3000);
				
				ExcelUtils.setCellData("Pass", 77, 6);
				
				 Thread.sleep(3000);
				 Contract_Screenshots.CaptureScreenshot(driver);
				 WebElement	 ExpirationDate1= driver.findElement(By.xpath(".//*[@id='tabContractDetails']/div/div/fieldset[1]/div[3]/div/span[1]/span/span/span"));
					ExpirationDate1.click();
					 Thread.sleep(3000);
					 int ok_size8=driver.findElements(By.xpath(".//a[@class='k-link'][@title ='Thursday, July 27, 2017']")).size();
						
						Thread.sleep(6000);
						driver.findElements(By.xpath(".//a[@class='k-link'][@title ='Thursday, July 27, 2017']")).get(ok_size8-1).click();
		...
		*/		
						...
						ExcelUtils.setCellData("Pass", 79, 6);
						 Thread.sleep(3000);
						 Contract_Screenshots.CaptureScreenshot(driver);
						 WebElement  Terminal_Dropdown1 = driver.findElement(By.xpath(".//*[@id='tabContractDetails']/div/div/fieldset[2]/div[1]/div/span[1]/span/span[2]/span"));
						...
						ExcelUtils.setCellData("Pass", 80, 6);
					     ...
					     driver.findElements(By.xpath(".//span[@class='k-list-filter']/input")).get(ok_size7-1).sendKeys(DropDownInput1);
					     Thread.sleep(3000);
					     Contract_Screenshots.CaptureScreenshot(driver);
					    ExcelUtils.setCellData("Pass", 82, 6);
						 ...
						 WebElement SupplierDropdown1 = driver.findElement(By.xpath(".//*[@id='tabContractDetails']/div/div/fieldset[2]/div[2]/div/span[1]/span/span[2]"));
						...
						ExcelUtils.setCellData("Pass", 83, 6);
						 ...
						 int ok_size6=driver.findElements(By.xpath(".//ul[@id='BaseContract_SupplierId_listbox']//li[@class='k-item'][@data-offset-index='0']")).size();
						 Thread.sleep(7000);
						 driver.findElements(By.xpath("//ul[@id='BaseContract_SupplierId_listbox']//li[@class='k-item'][@data-offset-index='0']")).get(ok_size6-1).click();
						// Thread.sleep(5000);
		...
		//			 driver.findElements(By.xpath(".//span[@class='k-list-filter']/input")).get(ok_size-1).click();
					...
					Contract_Screenshots.CaptureScreenshot(driver);
						 Thread.sleep(3000);
						 WebElement  VendorDropdown1 = driver.findElement(By.xpath(".//*[@id='tabContractDetails']/div/div/fieldset[2]/div[3]/div/span[1]/span/span[2]/span"));
						 VendorDropdown1.click();
						ExcelUtils.setCellData("Pass", 85, 6);
						 Contract_Screenshots.CaptureScreenshot(driver);
						 Thread.sleep(3000);
						 int ok_size5=driver.findElements(By.xpath(".//ul[@id='BaseContract_VendorId_listbox']//li[@class='k-item'][@data-offset-index='0']")).size();
						 Thread.sleep(6000);
						 
						 driver.findElements(By.xpath(".//ul[@id='BaseContract_VendorId_listbox']//li[@class='k-item'][@data-offset-index='0']")).get(ok_size5-1).click();
