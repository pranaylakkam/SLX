...
public class Trailer_Validation {
	 ...
	 public static MouseHandler mouse (WebDriver driver) throws Exception {
	   	 ...
	   	 action.moveToElement(element).moveToElement(driver.findElement(By.xpath(".//*[@id='main']/div[1]/div/div[2]/div/div/ul/li[1]/ul/li[26]/a"))).click().build().perform();
	 ...
	 public static WebElement Number( WebDriver driver) throws Exception{
	  ...
	  public static WebElement WareHouseidDropdown(WebDriver driver){
		  ...
		  WareHouseidDropdown = driver.findElement(By.xpath(".//*[@id='tabDetails']/div/div/fieldset[1]/div[3]/div/span[1]/span/span[2]/span"));
